    ...
    <div class="user-list" v-loading="loading">
      ...
      <div v-for="item in users" :key="item.userId" class="user-item">
        ...
        <div class="user-actions">
          ...
          <el-button size="small" type="danger" @click="handleUnfollow(item.userId)">取消关注</el-button>
        </div>
      </div>
    </div>
...
import { getMyFollowings, unfollowUser, type UserInfoVO } from '@/api/follow'
